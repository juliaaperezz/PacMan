...
class QLearningAgent(ReinforcementAgent):
    ...
    def compute_action_from_q_values(self, state):
        ...
        best_actions = [action for action in legal_actions if self.get_q_value(state, action) == best_value]
...
class ApproximateQAgent(PacmanQAgent):
    ...
    def update(self, state, action, next_state, reward):
        ...
        "*** YOUR CODE HERE ***"
        features = self.feat_extractor.get_features(state, action)
        correction = (reward + self.discount * self.compute_value_from_q_values(next_state)) - self.get_q_value(state, action)
